...
class CourseFetcherConfig(BaseRequestConfig):
    ...
    def __init__(self, session_id, params=None, referer=_DEFAULT_REFERER, base_url=_DEFAULT_BASE_URL):
        super(CourseFetcherConfig, self).__init__(session_id, params, referer, base_url)
...
class TableFetcherConfig(BaseRequestConfig):

    _DEFAULT_REFERER = "http://jwgl.ouc.edu.cn/student/wsxk.kcbcx.html?menucode=JW130410"
    _DEFAULT_BASE_URL = "http://jwgl.ouc.edu.cn/taglib/DataTable.jsp?tableId=6093"


    def __init__(self, session_id=None, params=None, referer=_DEFAULT_REFERER, base_url=_DEFAULT_BASE_URL):
        if params is None:
            params = TableFetcherParams()
        super(TableFetcherConfig, self).__init__(session_id, params, referer, base_url)
